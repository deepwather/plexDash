(function() {
  ...
  angular.module('plexDash').directive('diskSpace', ['server', function(server) {
    return {
      restrict: 'E',
      scope: {},
      templateUrl: 'main_files/modules/disk-space.html',
      link: function(scope) {
  ...
  angular.module('plexDash').directive('ramChart', ['server', function(server) {
    return {
      restrict: 'E',
      scope: {},
      templateUrl: 'main_files/modules/ram-chart.html',
      link: function(scope) {
  ...
  angular.module('plexDash').directive('cpuAvgLoadChart', ['server', function(server) {
    return {
      restrict: 'E',
      scope: {},
      templateUrl: 'main_files/modules/cpu-load.html',
      link: function(scope) {
        scope.units = '%';
      }
    };
  ...
  angular.module('plexDash').directive('cpuUtilizationChart', ['server', function(server) {
    return {
      restrict: 'E',
      scope: {},
      templateUrl: 'main_files/modules/cpu-utilization-chart.html',
      link: function(scope) {
        scope.min = 0;
        scope.max = 100;
  ...
  angular.module('plexDash').directive('uploadTransferRateChart', ['server', function(server) {
    return {
      restrict: 'E',
      scope: {},
      templateUrl: 'main_files/modules/upload-transfer-rate.html',
      link: function(scope) {
        scope.delay = 2000;
        scope.units = 'KB/s';
      }
  ...
  angular.module('plexDash').directive('downloadTransferRateChart', ['server', function(server) {
    return {
      restrict: 'E',
      scope: {},
      templateUrl: 'main_files/modules/download-transfer-rate.html',
      link: function(scope) {
        scope.delay = 2000;
        scope.units = 'KB/s';
      }
  ...
  simpleTableModules.forEach(function(module, key) {
    ...
    angular.module('plexDash').directive(module.name, ['server', function(server) {
      ...
      if (module.templateUrl) {
        moduleDirective['templateUrl'] = 'main_files/modules/' + module.templateUrl
      }
